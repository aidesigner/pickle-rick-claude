...
export interface ReadinessFinding {
  ticket: string;
  kind: 'machinability' | 'contract';
  message: string;
  analyst: 'gaps' | 'codebase';
  detail: string;
}
...
function resolvePathRef(ref: string, repoRoot: string): boolean {
...
function writeReport(sessionDir: string, findings: ReadinessFinding[], escalation: boolean): string {
...
export function runReadiness(args: ReadinessArgs): { exitCode: number; findings: ReadinessFinding[]; reportPath?: string; delta: boolean } {
