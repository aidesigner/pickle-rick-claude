...
- **`.claude/commands/`**: Slash commands (`/pickle`, `/pickle-prd`, `/eat-pickle`, `/help-pickle`, `/add-to-pickle-jar`, `/pickle-jar-open`, `/disable-pickle`, `/enable-pickle`)
- **`extension/bin/`**: Runtime scripts (setup, cancel, spawn-morty, worker-setup, update-state, get-session, jar-runner)
