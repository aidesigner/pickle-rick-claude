...
This project is indexed by GitNexus as **pickle-rick-claude** (26348 symbols, 38998 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
