...
This project is indexed by GitNexus as **pickle-rick-claude** (25292 symbols, 37629 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
