...
import { buildManagerSpawnCommand, buildWorkerSpawnCommand, formatDryRun, listRuntimes, } from './services/runtime-adapter.js';
// ---------------------------------------------------------------------------
// Kill Escalation
// ---------------------------------------------------------------------------
export async function killWithEscalation(pid, graceSeconds) {
    try {
...
// Manager Spawn
// ---------------------------------------------------------------------------
export async function spawnManager(args) {
