...
| Item | Value |
|---|---|
| Version (source/deployed) | **v1.80.3** — 2026-05-27 |
| Latest GitHub release | v1.80.3 — 2026-05-27 |
...
|---|---|---|---|---|
| **NEXT** | **B-PIPE-BABYSIT-HARDEN** | **NEXT** | #80 R-OMS + #81 R-AISLOW + #82 R-SJLAG | bundle PRD `p1-bug-fix-bundle-b-pipe-babysit-harden-2026-05-27.md`. 7 tickets + closer. Long-running-pipeline health from the B-RELEASE-DRIFT babysit: A R-AISLOW pre-skip (2, **6h→2h elapsed**), B R-OMS orphan-manager reaping (3, schema-neutral sidecar pidfile + ps-scan to dodge #74 schema-bump-mid-run gap), C R-SJLAG state-freshness heartbeat (2). Closer bumps **v1.81.0** (MINOR — new events, NO schema change). Dispatch A→B→C→close. |
