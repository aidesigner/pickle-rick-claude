...
| 17 | **B-CBI** (LAUNCHING) | P2 | (feature — R-CBI grok+kimi) | `prds/p2-bug-fix-bundle-b-cbi-grok-kimi-native-cli-backends.md` (authored 2026-06-02 from the R-CBI contract). Both CLIs installed (grok 0.2.17, kimi 1.38.0) + unwired → feasible. 5 tickets: R-CBI-GROK-1 measure → GROK-2 implement; R-CBI-KIMI-1 measure → KIMI-2 implement; closer. Measure-first per instance (capture real `--help` before builder), INV-SWARM-OFF (worker swarm off), honest identity. Follows hermes/deepseek pattern. MINOR (→1.93.0). | ~5 |
