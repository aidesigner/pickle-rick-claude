...
3. **NEXT — B-CWRR** — citadel monorepo workingDir doubling (#88, sized ~3 tickets). **PRD authored 2026-05-29 by babysitter (Author+launch policy)**: `prds/p1-bug-fix-bundle-b-cwrr-citadel-workingdir-as-reporoot-2026-05-29.md` (from `BUG-REPORT-2026-05-28-citadel-monorepo-workingdir-as-reporoot-path-doubling.md`). Launchable.
