...
| Item | Value |
|---|---|
| Version (source/deployed) | **v1.82.1** — 2026-05-29 (source bumped; deploy + tag pending babysitter finalization) |
| Latest GitHub release | v1.81.0 — 2026-05-27 (v1.81.1 + v1.82.0 + v1.82.1 push/tag pending — auto-finalize on next babysitter tick `7e209376` PART 2) |
