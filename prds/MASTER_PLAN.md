...
|---|---|---|---|
| 1 | [`prds/p1-reliability-and-test-coverage-bundle-2026-05-03.md`](p1-reliability-and-test-coverage-bundle-2026-05-03.md) ⭐ **NEW P1 BUNDLE** | **Draft** — composes the 4 open bug PRDs (Sections A–D) plus a cross-cutting Section E (test tiers, deploy-soak e2e, pipeline-empty-queue e2e, stop-hook state matrix, test-isolation audit, coverage baseline, mock contract drift, flake quarantine, release-gate hardening). 12 R-RTC + 12 AC-RTC at the bundle layer; per-section ACs flow through from sources. **Diagnose-first** discipline preserved per section. Replaces queue slots #1a–#1d. | `/pickle-pipeline prds/p1-reliability-and-test-coverage-bundle-2026-05-03.md` (refinement Step 0 inside skill) |
