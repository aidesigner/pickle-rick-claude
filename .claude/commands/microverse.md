...
2. Run the validation command to see current output: execute the command shown in `Validation:`
...
5. Run the validation command to confirm current score matches expectations
...
2. Run the validation command to verify improvement locally before committing
